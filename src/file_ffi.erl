...
file_info_result(Result) ->
    case Result of
        {ok,
            {file_info, Size, Type, Access, Atime, Mtime, Ctime, Mode, Links, MajorDevice,
                MinorDevice, Inode, Uid,
                Gid}} when Access =:= none ->
            {ok,
                {file_info, Size, Type, no_access, Atime, Mtime, Ctime, Mode, Links, MajorDevice,
                    MinorDevice, Inode, Uid, Gid}};
        {ok, _} ->
            Result;
