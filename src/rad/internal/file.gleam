...
/// ```
///
@external(erlang, "file_ffi", "file_info")
...
/// ```
///
@external(erlang, "file_ffi", "link_info")
@external(javascript, "./rad_ffi.mjs", "no_fun")
...
/// ```
///
@external(erlang, "file_ffi", "make_directory")
@external(javascript, "./rad_ffi.mjs", "no_fun")
...
/// ```
///
@external(erlang, "file_ffi", "list_directory")
@external(javascript, "./rad_ffi.mjs", "no_fun")
...
/// ```
///
@external(erlang, "file_ffi", "delete_directory")
@external(javascript, "./rad_ffi.mjs", "no_fun")
...
/// ```
///
@external(erlang, "file_ffi", "recursive_delete")
@external(javascript, "./rad_ffi.mjs", "no_fun")
...
/// ```
///
@external(erlang, "file_ffi", "delete_file")
@external(javascript, "./rad_ffi.mjs", "no_fun")
